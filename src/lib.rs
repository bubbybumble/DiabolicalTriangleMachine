...
struct DiabolicalTriangleMachine {
    params: Arc<DiabolicalTriangleMachineParams>,
...
#[derive(Params)]
struct DiabolicalTriangleMachineParams {
...
impl Default for DiabolicalTriangleMachine {
    fn default() -> Self {
        Self {
            params: Arc::new(DiabolicalTriangleMachineParams::default()),
...
impl Default for DiabolicalTriangleMachineParams {
    fn default() -> Self {
        Self {
            gain: FloatParam::new(
                "Gain",
...
impl Plugin for DiabolicalTriangleMachine {
    const NAME: &'static str = "Diabolical Triangle Machine";
    const VENDOR: &'static str = "Setscet";
    const URL: &'static str = env!("CARGO_PKG_HOMEPAGE");
    const EMAIL: &'static str = "bubbybumble@gmail.com";
...
impl DiabolicalTriangleMachine {
...
nih_export_clap!(DiabolicalTriangleMachine);
nih_export_vst3!(DiabolicalTriangleMachine);
